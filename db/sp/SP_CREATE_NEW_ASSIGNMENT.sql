...
START TRANSACTION;
	INSERT INTO assignments_tutors (assignmentId, assignmentDescription, assignmentPublishedAt, assignmentDeadline) 
	VALUES (p_assignmentId, p_assignmentDescription, p_assignmentPublishedAt, p_assignmentDeadline); 
    iterator:
	LOOP
        ...
        INSERT INTO assignments_students (assignmentId, studentId) VALUES (p_assignmentId, _value);
